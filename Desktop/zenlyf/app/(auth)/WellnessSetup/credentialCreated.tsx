  ...
  return (
    ...
    >
        <View style={{paddingHorizontal:24, display:"flex", flexDirection:"column", justifyContent:"space-between",alignItems:"center", gap:121}}>
            ...
            <H4 style={{fontSize:32,fontWeight:"500", color:"#050505", textAlign:"center"}}>You're protected {"\n"} with Zenlyf!</H4>
            <P style={{color:"#888888", fontWeight:"400", fontSize:18, textAlign:"center"}}>We'll quietly look out for you. You'll only hear from us when something needs your attention.</P>
            </View>
            </View>
         ...
         <View style={{display:"flex", flexDirection: "columm", gap:16,width:"100%"}}>
            ...
            <TouchableOpacity 
            onPress={() => router.push("/(auth)/threeTierSetup")}
